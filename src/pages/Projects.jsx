        ...
        <main id="projects-container">
            ...
            <div id="projects">
                <section id="project1" class="project">
                    ...
                    <p>The Gen Z Work Journal is a web application designed to help users manage tasks, set goals, and stay motivated through an interactive reward system. As users complete tasks and log their progress, they earn points that allow their character to evolve from an egg into a fully developed creature, such as a Monkey or a Dragon. The app features a Calendar & Journal section where users can log daily reflections, search past entries, and switch between calendar and journal views. The Goal Setting feature allows users to create and track daily, weekly, and long-term goals, marking them as complete or editing them as needed. The Rewards System keeps users engaged by awarding points that contribute to their character's evolution, providing a fun incentive to stay productive. Additionally, the Creative Play section includes a whiteboard feature using p5.js, allowing users to draw, take notes, or doodle. Future enhancements include GitHub integration to track work logs, journal entry labels for better organization, and advanced search functionality. The project is built using React.js for a smooth user interface, with plans to enable PWA support for offline use. This app creates a fun and engaging way for users to stay organized and motivated.</p>
